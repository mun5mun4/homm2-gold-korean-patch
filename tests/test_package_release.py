        ...
        "upgrades": {
            ...
            "from": [
                ...
                },
                {
                    ...
                    "manifest_path": UPGRADE_MANIFEST_PACKAGE_PATHS[6],
                    "manifest": dict(package_release.BETA10_MANIFEST_IDENTITY),
                },
            ],
        },
    }
...
class PackageReleaseAllowlistTests(unittest.TestCase):
    ...
    def test_rejects_beta10_as_the_current_release(self) -> None:
        manifest = fixture_manifest(version="v0.9.0-beta.10")

        with self.assertRaisesRegex(package_release.PackageError, "pinned to beta.11"):
            package_release.expected_release_files(manifest, "v0.9.0-beta.10")

    def test_rejects_legacy_manifest_schema_for_beta11(self) -> None:
