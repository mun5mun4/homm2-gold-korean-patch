...
## v0.9.0-beta.10 — 2026-08-28

- DOSBox-X 디버그 실행과 기본 GOG DOSBox 실행에서 달라질 수 있는 LE Object 로드 주소에 독립적인 영상 자막 로더로 교체
- 기본 GOG 바로가기에서 게임 실행과 오리지널 캠페인 자막 표시를 사용자 실기로 확인
- 자막 문장에 남아 있던 아라비아 숫자를 한글 수사로 바꿔 영상 자막의 숫자 높이 차이를 완화
- 51개 영상·57개 장면·388개 자막 큐와 렌더러 v3 기반 이롭게 바탕체 설치 방식을 유지
- 공개 beta.4·beta.5·beta.6·beta.7·beta.8·beta.9 설치본에서 beta.10 직접 업그레이드 지원
